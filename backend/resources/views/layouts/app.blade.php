...
<body class="min-h-screen flex flex-col">
    ...
    <a href="https://wa.me/8801873722228" target="_blank" class="fixed bottom-6 right-6 z-50 w-14 h-14 bg-green-500 rounded-full flex items-center justify-center shadow-lg hover:bg-green-400 transition-colors">
